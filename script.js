(() => {
  ...
  function deleteTask(id) {
    ...
    if (li) {
      // wait for the exit animation to finish before removing from data
  ...
  function flashTask(id) {
    ...
    void li.offsetWidth; // reading offsetWidth forces a browser reflow, resetting the animation
